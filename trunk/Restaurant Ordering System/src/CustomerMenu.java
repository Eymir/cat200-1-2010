...
//            rs = stmt.executeQuery("select food_number, food_name, food_price, food_qn, food_min from foodtable");
//            
//            while (rs.next()) {
...
//    
    ...
    private void orderButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_orderButtonActionPerformed
        ...
        //odp.foodNameLabel.setText((String)foodList.getModel().getElementAt(0));
